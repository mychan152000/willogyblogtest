...
where <span class="self-supervised-learning-amdim-deep-infomax-cpc-image-10"> ![](../../static/images/uploads/ssl3_inline1.gif) </span> is a set of negative samples and <span class="self-supervised-learning-amdim-deep-infomax-cpc-image-10"> ![](../../static/images/uploads/ssl3_inline2.gif) </span> is a softmax function:
