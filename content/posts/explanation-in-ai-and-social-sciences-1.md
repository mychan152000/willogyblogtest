...
.xai-explainable-ai-social-science-image-70 img {
  width: 70%;
  margin: auto;
}
...
Many AI subfields will get considerable advantage from the ability of explanation, such as “justifying autonomous agent behavior, debugging machine learning models, explaining medical decision-making” \[1]. However, the author says that most of the recent research in XAI still depends a lot on the researchers’ intuitions to specify what is a good explanation. In the paper, the author defines the term “Explainable AI” as “an explanatory agent revealing underlying causes to its or another agent’s decision making” \[1].
...
In the paper, he confines his attention to the top circle of social science and its relation to the other two circles.

<div class="xai-explainable-ai-social-science-image-70">

![explainable ai social science human-computer interaction](../../static/images/uploads/scope_of_explainable_artificial_intelligence.jpg)
...
* Explanation of why particular facts (events, properties, decisions, etc.) happened, those that are not generalized theories in science.
